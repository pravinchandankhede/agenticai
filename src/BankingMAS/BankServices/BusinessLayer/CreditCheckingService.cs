...
public class CreditCheckingService : GenericService<CreditChecking>
{
    private readonly CreditCheckingRepository _repository;

    public CreditCheckingService(CreditCheckingRepository repository)
        :base(repository)
    {
    ...
    // Delete an entity
    public override async Task DeleteAsync(CreditChecking entity)
    {
